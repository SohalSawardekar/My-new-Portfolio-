            ...
            <div className="flex relative justify-around items-center px-6">
                ...
                <div className="flex flex-row space-x-8 pr-6">
                    ...
                    <a href="https://linkedin.com/in/sohal-sawardekar-10a484265" target="_blank" rel="noopener noreferrer">
                        <img src="/icons/icons8-linkedin.svg" alt="Twitter" className="h-8 opacity-80 hover:opacity-100" />
                    </a>
                    
                    {/* github */}
                    <a href="https://github.com/SohalSawardekar" target="_blank" rel="noopener noreferrer">
                        <img src="/icons/icons8-github.svg" alt="Twitter" className="h-8 opacity-80 hover:opacity-100" />
                    </a>
                </div>
            </div>
        </div>
